...
const ProductRightPart = () => {
  ...
  console.log(filterProductData, "hsjhwjaeh");

  return (
    <div>
      <input
        onChange={handleSearch}
        className="border py-1 w-[600px] rounded-full"
        type="text"
        placeholder="Search"
      />
          ...
          {filterProductData.length > 0
            ? filterProductData.map((product) => (
                <Link
                  ...
                  className=" relative w-[270px] mb-[20px]"
                >
                  ...
                  <div className="mt-4">
                    ...
                    <p className="font-primary font-medium py-2 text-primary">
                      ${product.price}{" "}
                      <del className="text-green-500">${product.price}</del>{" "}
                    </p>
