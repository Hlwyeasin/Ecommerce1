	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" width="81" height="80" fill="none">
			...
			<g
				...
				clip-path="url(#a)"
			>
				<path d="M32.167 51.667a3.333 3.333 0 1 0 0-6.667 3.333 3.333 0 0 0 0 6.667ZM48.833 51.667a3.333 3.333 0 1 0 0-6.667 3.333 3.333 0 0 0 0 6.667Z" />
				<path d="M28.833 48.334H27.5a2 2 0 0 1-2-2v-4.667m-1.667-13.334h16.334a2 2 0 0 1 2 2v18m-6.667 0h10m6.667 0H53.5a2 2 0 0 0 2-2v-8m0 0H42.167m13.333 0-4.417-7.362a2 2 0 0 0-1.715-.97h-7.201" />
