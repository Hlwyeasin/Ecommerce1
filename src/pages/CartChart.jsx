 ...
 {/* first list div */}
         ...
         {/* div one copone code  */}
              <div> 
               ...
               <button className="mt-10 ml-4 py-4 px-[60px] bg-primary
              text-white font-primary font-semibold rounded-lg cursor-pointer">Apply Coupon</button>
              ...
              text-white font-primary font-semibold rounded-lg cursor-pointer">Procees to checkout</button>
                </div>
                </div>
